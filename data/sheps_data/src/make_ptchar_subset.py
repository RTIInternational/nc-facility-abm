...
if __name__ == "__main__":
    ...
    import_file = main_dir.joinpath(f"{year}_master_ptchar_final.csv")
    ...
    subset_df.index.name = "Category"
    subset_df.to_csv(main_dir.joinpath(f"{year}_subset_ptchar_for_analysis.csv"))
